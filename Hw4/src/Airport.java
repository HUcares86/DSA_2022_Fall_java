...
class Airport {
    ...
    public double airport(List<int[]> houses) {
        ...
        for (int[] house : houses) {
            Point2D house_to_add = new Point2D(house[0], house[1]);
            village.add(house_to_add);
        }

        // find convex hull
        Point2D origin = village.get(0);
        // find lowest y point
        for (Point2D point2D : village) {
            if (point2D.y() < origin.y()) origin = point2D;
        }
        // remove origin from village
        ...
        // closest
        village.sort(origin.distanceToOrder());
        // smallest angle
        village.sort(origin.polarOrder());
        // add orgin
        hull.add(origin);
        // must be the next point of hull
        ...
        // the end start and no1 is a strait line
...
//            add(new int[]{0,1});
//        }}));
//        System.out.println(0.2357022603955159);
//        System.out.println("---------");
//        System.out.println(new Airport().airport(new ArrayList<int[]>(){{
//            add(new int[]{0,0});
//            add(new int[]{2,0});
